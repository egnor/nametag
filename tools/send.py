...
parser.add_argument("--frames", nargs="+", help="animation images")
parser.add_argument("--glyphs", nargs="+", help="glyph images")
...
print(f"{len(send_expect)} packets" if send_expect else "No command requests")
print()
